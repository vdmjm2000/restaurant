...
$contenu_plat .= '<table class="table-responsive"p id="profile" border="1"><tr>';
...
$contenu_plat .= '<th class="d-none d-md-table-cell">Suppression</th>'; // Masque la colonne de suppression sur les appareils mobiles
$contenu_plat .= '</tr>';
...
while ($ligne = $resultat5->fetch_assoc()) {
  ...
  $contenu_plat .= '<td class="d-none d-md-table-cell"><a href="?action=suppression&id_recipe=' . $ligne['id_recipe'] . '");"><img src="../photo/icone/delete.png"></a></td>'; // Masque le lien de suppression sur les appareils mobiles
  $contenu_plat .= '</tr>';
}
